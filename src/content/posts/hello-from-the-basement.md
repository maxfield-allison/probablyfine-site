...
firewall doing BGP for health-checked service VIPs. It is over-engineered on purpose — the
...
- **Architecture write-ups** — how the cluster is put together and *why*, including the
  trade-offs that do not make it into the diagrams.
...
Some of these posts — including this one — are written with an AI agent in the loop. That
is not vibe coding. I design the systems, make the technology calls, review the output, and
