...
The hours have no counter, but that is not the same as being unknowable.
...
Capitalism demands value and infinite growth. Pricing the hours assumes I spent them to get something, and sure, some of them I did. But I would do this if it paid nothing and led nowhere. I have turned down a night of gaming for a lab project more times than I can count, and a lab project can mean standing up AI services on my own cluster, or building a self-hosted replacement for the entire Google suite, or writing this.
